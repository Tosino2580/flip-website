...
function Flip() {
  ...
  const imagesPerPage = 12; // Adjusted to standard grids (12 is divisible by 2, 3, 4)
      ...
      <div className="max-w-[1450px] w-11/12 md:w-4/5 mx-auto pb-20 space-y-12">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-400 mt-3 max-w-md mx-auto text-xs md:text-sm">
            Relive the magical outdoor moments, live performances, and community connections from our first edition. Click any image to view it full screen.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {currentImages.map((item, index) => (
            ...
            >
              <img
                src={item.image}
                alt={`FLIP 1.0 Atmosphere ${index + 1}`}
